...
def draw_header(subtitle=""):
    ...
    # DROGON 🐉 Premium Banner
    dragon_logo = f"""{Colors.GOLD}
╔══════════════════════════════════════════════════════════╗
║                                                          ║
║      ██████╗ ██████╗  ██████╗  ██████╗ ███╗   ██╗      ║
║      ██╔══██╗██╔══██╗██╔═══██╗██╔═══██╗████╗  ██║      ║
...
║      ╚═════╝ ╚═╝  ╚═╝ ╚═════╝  ╚═════╝ ╚═╝  ╚═══╝      ║
║                                                          ║
║         🐉  S U B R O T O  B I N D  T O O L  🐉          ║
╚══════════════════════════════════════════════════════════╝{Colors.END}"""
    print(dragon_logo)
    
    # Decorative separator
    print(f"{Colors.DARK_RED}╔{'═' * 58}╗{Colors.END}")
    print(f"{Colors.DARK_RED}║{Colors.END} {Colors.GOLD}🐉 DEVELOPER :{Colors.END} {Colors.WHITE} @Krishna_Subroto {Colors.END}{Colors.DARK_RED}                 ║{Colors.END}")
    print(f"{Colors.DARK_RED}║{Colors.END} {Colors.GOLD}🔥 CHANNEL  :{Colors.END} {Colors.WHITE} @Krishna_modz {Colors.END}{Colors.DARK_RED}         ║{Colors.END}")
...
def owner_details():
    ...
    print(f"{Colors.GOLD}║{Colors.END} {Colors.GOLD}🐉 Developer Name :{Colors.END} {Colors.WHITE}SUBROTO ROY{Colors.END}")
    print(f"{Colors.GOLD}║{Colors.END} {Colors.GOLD}🐉 Telegram       :{Colors.END} {Colors.WHITE}⊛ @Krishna_Subroto{Colors.END}")
    print(f"{Colors.GOLD}║{Colors.END} {Colors.GOLD}🐉 Channel / Group:{Colors.END} {Colors.WHITE}https://t.me/Krishna_modz{Colors.END}")
    print(f"{Colors.GOLD}║{Colors.END} {Colors.GOLD}🐉 Tool Version   :{Colors.END} {Colors.GREEN}v3.0 (Premium Dragon Edition){Colors.END}")
    
    print(f"\n{Colors.GOLD}╠{'═' * 18} ═══ SPECIAL NOTE ═══ {'═' * 16}╣{Colors.END}\n")
    
    print(f"{Colors.GOLD}║{Colors.END} {Colors.YELLOW}🔥 Thank you for using Subroto Bind Tool!{Colors.END}")
...
def show_menu():
    draw_header()
    print(f" {Colors.CYAN}🐉 DRAGON MENU OPTIONS:{Colors.END}")
